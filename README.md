...
*Generated by `eval/render_readme.py` on 2026-08-29. Regenerated on every pipeline run — the [live dashboard](https://zeref538.github.io/apaw/) and this table cannot drift apart.*
